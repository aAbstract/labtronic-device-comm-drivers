...
lt_ch000_driver_config = MsgTypeConfigArr(
    MsgTypeConfig(msg_type=FFIDefines.WRITE_PISTON_PUMP_MSG_TYPE, data_type=FFIDefines.DATA_TYPE_UINT, size_bytes=4, cfg2=0),
    MsgTypeConfig(msg_type=FFIDefines.WRITE_PERISTALTIC_PUMP_MSG_TYPE, data_type=FFIDefines.DATA_TYPE_UINT, size_bytes=1, cfg2=0),
    MsgTypeConfig(msg_type=FFIDefines.WRITE_WEIGHT_MSG_TYPE, data_type=FFIDefines.DATA_TYPE_FLOAT, size_bytes=4, cfg2=0),
    MsgTypeConfig(msg_type=FFIDefines.WRITE_TEMPERATURE_MSG_TYPE, data_type=FFIDefines.DATA_TYPE_FLOAT, size_bytes=4, cfg2=0),
    MsgTypeConfig(msg_type=FFIDefines.WRITE_PRESSURE_MSG_TYPE, data_type=FFIDefines.DATA_TYPE_FLOAT, size_bytes=4, cfg2=0),
    MsgTypeConfig(msg_type=FFIDefines.WRITE_DEVICE_ERROR, data_type=FFIDefines.DATA_TYPE_UINT, size_bytes=1, cfg2=0),
    MsgTypeConfig(msg_type=FFIDefines.READ_PISTON_PUMP_MSG_TYPE, data_type=FFIDefines.DATA_TYPE_UINT, size_bytes=4, cfg2=0),
    MsgTypeConfig(msg_type=FFIDefines.READ_PERISTALTIC_PUMP_MSG_TYPE, data_type=FFIDefines.DATA_TYPE_UINT, size_bytes=1, cfg2=0),
    MsgTypeConfig(msg_type=FFIDefines.READ_RESET_SCALE_MSG_TYPE, data_type=FFIDefines.DATA_TYPE_COMMAND, size_bytes=1, cfg2=0),
)
...
def cmp_msg_type_config(config_1: MsgTypeConfig, config_2: MsgTypeConfig) -> bool:
    ...
    cmp_flag &= config_1.cfg2 == config_2.cfg2
    return cmp_flag
